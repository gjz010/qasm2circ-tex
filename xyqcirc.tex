...
\setlength{\textwidth}{10.25in}		% 6.0in text - 1.25in rt margin
\setlength{\textheight}{8.6in}		% Body ht for 1in margins
\paperwidth 20 true in
\paperheight 20 true in
\addtolength{\topmargin}{-\headheight}	% No header, so compensate
\addtolength{\topmargin}{-\headsep}	% for header height and separation
\newcommand{\mattwo}[4]{\left[ \begin{array}{cc}#1 & #2 \\ #3 & #4\end{array}\right]}
\newcommand{\vecttwo}[2]{\left[ \begin{array}{cc}#1 & #2\end{array}\right]}
...
% measurement box
\def\meter{*+[]{\put(-3,0){\includegraphics[scale=.5]{meter.pdf}}~~~~}%
		\ar@{-}[l]}
